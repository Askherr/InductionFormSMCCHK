        ...
        <div class="card mx-auto" style="width: 22rem;">
          <div class="card-body">
            <span><img src="/asset/SMCC-HK-LOGO.png" width="100%" alt=""></span>
              <h5 class="card-title text-center" style="margin-bottom: 40px;">Register | Daftar</h5>
            <form action="/register" method="POST">
              ...
              <div class="mb-2">
                ...
                <div class="mb-2">
                  ...
                  <input type="text"name="phone" class="form-control @error('phone') is-invalid @enderror" id="phone" aria-describedby="emailHelp" required>
                  @error('phone')
                <div class="alert alert-danger"> {{$message}}</div>
                @enderror
                </div>
