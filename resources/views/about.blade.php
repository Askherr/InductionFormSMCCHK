  ...
  <body>
    ...
    <div class="container-navbar">
      ...
      <div class="container text-center" id="welcome">
          <h1>E-Registration for Safety Induction</h1> <br>
          <h2 style="color: rgb(202, 199, 199);">MRT JAKARTA CP203 <br>SMCC-HK Joint Operation</h2>
      </div>

      <!-- buttongroup login register -->
      <div class="container text-center">
          <div class="btn-group">
              <a href="/register.html" type="button" class="btn btn-primary" id="btn">Register</a>
            </div>
        </div>
